...
class EndGameDataGenerator():
    ...
    def __init__(self, _api_key: str, name: str) -> None:
        if name is None:
            ...
            print("An error occurred with the constructor for EndGameDataGenerator")
    ...
    def getOneGameStatsWithResponse(self, response: requests.Response):
        match_detail = response.json()
        # if EndGameDataGenerator.isRanked(match_detail) == False:
        #     return None
    ...
    def getMultipleGameStatsByIdWithResponse(self, matchIdList):
        ...
        for matchId in matchIdList:
            ...
            match_detail = EndGameDataGenerator.getOneMatchDetail(self, )
